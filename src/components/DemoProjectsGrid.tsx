...
export default function DemoProjectsGrid({ products }: DemoProjectsGridProps) {
  ...
  return (
    <section aria-label="Progetti Demo Live" className="w-full py-4">
      {/* Header */}
      ...
      <div className="relative">
        ...
        {/* Gradients laterali */}
        <div className="absolute inset-y-0 left-0 w-16 sm:w-24 bg-gradient-to-r from-white/80 dark:from-slate-950/80 to-transparent pointer-events-none" />
        <div className="absolute inset-y-0 right-0 w-16 sm:w-24 bg-gradient-to-l from-white/80 dark:from-slate-950/80 to-transparent pointer-events-none" />
      </div>
