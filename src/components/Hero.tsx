...
// Spostiamo la logica di generazione qui per pulizia
...
const HeroSpace = () => {
  ...
  // 1. Inizializziamo le particelle come array vuoto
  ...
  return (
    ...
    >
      ...
      >
        {/* 3. Renderizziamo solo se ci sono particelle (evita il mismatch SSR) */}
